        ...
        <div className="bg-black md:h-full md:w-[50%] flex flex-col gap-4 px-6 ">
          ...
          <ul className="list-disc flex flex-col gap-5">
            ...
            <li>
              ...
              Familiar with Context API and currently diving into Redux Toolkit
              to handle complex application states.
            </li>
            <li>
              <span className="text-[#99ff00] text-xl">Backend Basics</span>: I
              have experience with Firebase and Appwrite for authentication and
              database management.
            </li>
            <li>
              <span className="text-[#99ff00] text-xl">
